...
namespace EntityTypeExp
{
    ...
    public class EntityType
    {
        ...
        /// </summary>
        private EntityTypesCollection m_AggregationSubClasses;
        ...
        /// агрегатные подклассы
        /// </summary>
        public EntityTypesCollection AggregationSubClasses
        {
        ...
        public void ParseExpression(string expression)
        {
            ...
            ////[1] ЭлементФайловойСистемы::Папка<ЭлементФайловойСистемы>;ЭлементФайловойСистемы::Файл;
            ////[2] ФайлМузыки
            ...
            ////[1] агрегированные подклассы -  Файл::ФайлМузыки / ЭлементФайловойСистемы / нет 
        ...
        /// <summary>
        /// NR-Парсим первую часть выражения класса, содержащую имя суперкласса и имя класса
        /// </summary>
